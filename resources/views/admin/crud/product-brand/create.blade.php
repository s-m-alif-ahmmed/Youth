                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="border p-3 ">
                            <form class="row g-3" method="post" action="{{route('product-brand.store')}}">
                                @csrf
                                @method('post')

                                <div class="col-12">
                                    <label for="name" class="form-label"> Brand Name</label>
                                    <input class="form-control" type="text" name="name" id="name" placeholder="Enter brand name" required />
                                </div>
