                            ...
                            <tr>
                                ...
                                <td>
                                    @if($brand->filter_status == 'active')
                                        <a href="{{ route('change.product-brand.filter.status', $brand->id) }}">
                                    ...
                                    @else($brand->filter_status == 'inActive')
                                        <a href="{{ route('change.product-brand.filter.status', $brand->id) }}">
                                            <div class="main-toggle-group style1 d-flex flex-wrap mt-3">
                                ...
                                <td>
                                    @if($brand->status == 'active')
                                        <a href="{{ route('change.product-brand.status', $brand->id) }}">
                                            <div class="main-toggle-group style1 d-flex flex-wrap mt-3">
                                                <div class="toggle toggle-warning toggle-sm on">
                                                    <span></span>
                                                </div>
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="View">
                                            <a href="{{route('product-brand.show', $brand->product_brand_slug)}}" class="text-primary mx-1"><i class="fa fa-eye"></i></a>
                                        </span>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Edit">
                                            <a href="{{route('product-brand.edit', $brand->product_brand_slug)}}" class="text-warning mx-1"><i class="fa fa-edit"></i></a>
                                        </span>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Delete">
                                            <form action="{{ route('product-brand.destroy', $brand->id )}}" method="post" id="deleteForm{{ $brand->id }}">
                                                @csrf
                                                @method('DELETE')

                                                <button class="text-danger border-0" type="button" onclick="return deleteAction('{{ $brand->id }}', 'Are you sure to delete this brand?', 'btn-danger')">
