                            ...
                            <tr>
                                ...
                                <td>
                                    @if($social->status == 'active')
                                        <a href="{{ route('change.status.social.media', $social->id) }}">
                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="View">
                                            <a href="{{route('social-media.show', Crypt::encryptString($social->id) )}}" class="text-primary mx-1"><i class="fa fa-eye"></i></a>
                                        </span>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Edit">
                                            <a href="{{route('social-media.edit', Crypt::encryptString($social->id) )}}" class="text-warning mx-1"><i class="fa fa-edit"></i></a>
                                        </span>
                                        <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-placement="top" data-bs-trigger="hover focus" data-bs-content="Delete">
                                            <form action="{{ route('social-media.destroy', $social->id )}}" method="post" id="deleteForm{{ $social->id }}">
                                                @csrf
                                                @method('DELETE')

                                                <button class="text-danger border-0" type="button" onclick="return deleteAction('{{ $social->id }}', 'Are you sure to delete this social media?', 'btn-danger')">
