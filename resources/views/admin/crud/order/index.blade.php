                                ...
                                <td>
                                    <div class="table-actions d-flex align-items-center gap-3 fs-6">
                                        <span class="d-inline-block">
                                            <a href="{{route('admin.order.detail',$order->tracking_id )}}" class="btn btn-primary mx-1">Products Detail</a>
                                        </span>
                                        <span class="d-inline-block">
                                            <a href="{{ route('admin.invoice.order',$order->id) }}" class="btn btn-success mx-1">Invoice</a>
                                        </span>
                                    </div>
                                </td>
                            </tr>
