                ...
                <div class="col-xxl-2 col-lg-3 col-12">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row my-2">
                                    <form action="{{ route('home.product.shop.filter.price') }}" method="GET">
                                        ...
                                        <div class="card shadow border-0">
                                            <div class="price-card p-0 m-0">
                                                ...
                                                <div class="card-footer border-0 p-0 m-0">
                                                    <div class="text-end pb-3 pe-3 m-0">
                ...
                <div class="col-xxl-10 col-lg-9 col-12">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="float-end">
                                    <form method="GET" action="{{ route('products.sort.shop') }}">
                        ...
                        <div class="row" id="product-list">
                            @foreach($products->sortByDesc('created_at') as $product)
                                <div class="col-3 col-lg-3 col-md-6 col-sm-6 col-12 py-3">
