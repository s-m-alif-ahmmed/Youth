                ...
                <div class="col-xxl-2 col-lg-3 col-12">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row my-2">
                                    <form action="{{ route('home.filter.offer.price', $offer_product->offer_slug) }}" method="GET">
                ...
                <div class="col-xxl-10 col-lg-9 col-12">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="float-end">
                                    <form method="GET" action="{{ route('products.sort.offer', $offer_product->offer_slug) }}">
                        ...
                        <div class="row" id="product-list">
                            @foreach($offer_products->sortByDesc('created_at') as $product)
                            ...
                            <div class="pagination-simple col-md-12 pt-5">
                                {{ $offer_products->links('pagination::bootstrap-5') }}
                            </div>
